...
| `image/tiff; application=geotiff; profile=cloud-optimized` | [Cloud Optimized GeoTIFF](https://docs.ogc.org/is/21-026/21-026.html#_media_types_for_any_data_encodings) |
| `image/jp2`                                                | JPEG 2000                                                                                                 |
...
| `application/json`                                         | A JSON file (often metadata)                                                                              |
...
| _Recommended_ Image dimensions | < 600x600 px                                        | < 5000x500 px                                                      | any size                                                                                     |
| _Recommended_ File Formats     | PNG, JPEG, GIF, WebP                                | PNG, JPEG, WebP, COG                                               | COG, other cloud-native and/or tiled file formats with pyramids, ...                         |
